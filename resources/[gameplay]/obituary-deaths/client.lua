AddEventHandler('obituaryDied', function(playerId)
...
AddEventHandler('obituaryKilled', function(playerId, killerId, reason)
    local player = GetPlayerByServerId(playerId)
    local attacker = GetPlayerByServerId(killerId)
